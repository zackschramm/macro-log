      ...
      const res = await fetch('https://zbcxuffgmjuqarapfdwb.supabase.co/functions/v1/ai-proxy', {
        ...
        body: JSON.stringify({
          ...
          messages: [{ role: 'user', content: [
            ...
            { type: 'text', text: 'Read this nutrition/supplement label and respond ONLY with a single JSON object with no markdown. Include: name, serving_size, calories, protein, carbs, fat, and any of these that appear on the label (use exact key names, numeric values only): vitamin_a, vitamin_b1, vitamin_b2, vitamin_b3, vitamin_b5, vitamin_b6, vitamin_b7, vitamin_b9, vitamin_b12, vitamin_c, vitamin_d, vitamin_d3, vitamin_e, vitamin_k, vitamin_k2, calcium, magnesium, phosphorus, potassium, sodium, iron, zinc, copper, manganese, selenium, chromium, iodine, molybdenum, boron, silica, omega3, omega6, fiber, creatine, beta_alanine, caffeine, l_glutamine, l_citrulline, bcaa, coq10, ashwagandha, turmeric, probiotics, collagen, melatonin, electrolytes. If a nutrient is not present on the label omit its key. All values must be numbers in the label serving size units. If unreadable respond with {"error":"message"}.' },
          ]}],
          max_tokens: 1000,
        }),
      });
